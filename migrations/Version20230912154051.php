 ...
 */
final class Version20230912154051 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add relation between users and pins table';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        // Check if the user_id column doesn't exist in the pins table
        if (!$schema->getTable('pins')->hasColumn('user_id')) {
    ...
    public function down(Schema $schema): void
    {
        ...
        // Conditionally drop the user_id column if it was added in this migration
        if ($schema->getTable('pins')->hasColumn('user_id')) {
